...
public class Menu_cai extends JPanel {
    ...
    private void init() {
        ...
        addTitle("RAPPORT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LIST, "Liste des paiements"));
        addTitle("CAISSE");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PAYMENT, "Paiement"));
       ...
       // addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_CONTACT_CALENDAR, "Calendar"));
        addTitle("Etat");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PRINT, "Imprimmer","Paiement(s) D'aujourd'hui"," Tous les paiement"));
        addTitle("PROFIL");
