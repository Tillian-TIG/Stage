...
public class Menu_sec extends JPanel {
    ...
    private void init() {
        ...
        addTitle("PLANING D'ADMISSION");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LIST, "Liste","Consultations","Opérations"));
        //addTitle("GESTION DES CONSULTATIONS");
       ...
       addTitle("Etat");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PRINT, "Imprimmer","Planning D'aujourd'hui"," Rapport Actes médicaux"));
