...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        addTitle("RAPPORT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.CREDIT_CARD, "Paiement"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PRINT, "Imprimmer","Membre du personnelle"));
        addTitle("GESTION DES RESSOURCES");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PEOPLE, "Ajouter un membre"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ACCOUNT_BOX, "Etat des comptes","Mise à jour des comptes","Liste des comptes"));
         addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.HEALING, "Les Services"));
