...
public class Menu_med extends JPanel {
    ...
    private void init() {
        ...
        addTitle("RAPPORT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.FOLDER, "Dossiers Médicaux "));
        addTitle("SOINS");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.HEALING, "Traitement"));
