...
public class Menu_inf extends JPanel {
    ...
    private void init() {
        ...
        addTitle("RAPPORT");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.LIST, "Rapport des prises "));
        addTitle("ACTES");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERSON, "Constante"));
