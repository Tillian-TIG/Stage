...
public class TitleBar extends JComponent {
    ...
    private void init() {
        ...
        panel.add(resize);
         close.addMouseMotionListener(new MouseMotionAdapter() {
                ...
                public void mouseMoved(MouseEvent e) {
                    // Affichez le message lorsque la souris survole la carte1
                    close.setToolTipText("Fermer l'application");
                }
            });
        ...
        if (obj.getMessageType() == MessageDialog.MessageType.OK) {
          ...
          minimize.addMouseMotionListener(new MouseMotionAdapter() {
           
                @Override
                public void mouseMoved(MouseEvent e) {
                    // Affichez le message lorsque la souris survole la carte1
                    minimize.setToolTipText("Minimisé");
                }
            });
        minimize.addActionListener(new ActionListener() {
          ...
          resize.addMouseMotionListener(new MouseMotionAdapter() {
                ...
                public void mouseMoved(MouseEvent e) {
                    // Affichez le message lorsque la souris survole la carte1
                    resize.setToolTipText("Agrandir/Réduire");
                }
            });
